...
DogeDodge.Play.prototype = {
  ...
  preload: function () {
    this.load.image('background','assets/flappyBackground.png');
    this.load.spritesheet('dodger','assets/char.png',46,64,2); // (w,h,f)
    this.load.spritesheet('dodge','assets/fone.png',64,64,1); // (w,h,f)
  },
